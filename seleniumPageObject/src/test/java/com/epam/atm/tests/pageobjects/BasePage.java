...
// TODO: suggest to renaim to basePage or something similar. - FIXED
public class BasePage {
    ...
    public BasePage(WebDriver driver) {
        this.driver = driver;
        // TODO: Page factory need to be used when you use @FindBy annotations. - FIXED

    }

    public void waitElementToBeClicable(By elementBy) {
        // TODO: Number of seconds could be moved as a constant to separate class. It could be easily modified. - FIXED
    ...
    // TODO: name of method looks confusing. By the code seems like method check if any element is visible. - FIXED
